...
function Footer() {
  ...
  return (
    <footer className="text-gray-600 body-font border-t-[1px]">
        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-600 hover:text-gray-800" href="/">Horror</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800" href="/">Romantic</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800" href="/">Bengali</a>
              </li>
              <li>
                <a className="text-gray-600 hover:text-gray-800" href="/">Sci-fi</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
